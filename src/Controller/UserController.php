...
class UserController extends AbstractController
{
    ...
    public function createAction(Request $request, UserPasswordHasherInterface $hash, 
    ...
    public function editAction(User $user, Request $request, UserPasswordHasherInterface $hash,
    EntityManagerInterface $entityManager )
    {
        $form = $this->createForm(UserType::class, $user);
